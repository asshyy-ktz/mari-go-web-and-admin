                                ...
                                <table class="payment-table">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right payment-buttons">
                                            ...
                                            <form action="<?php echo route('process_rental_stripe'); ?>" method="post">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input name="cardholder-name" required type="text"
                                                               placeholder="{{trans('lang.card_holder')}}"
                                                               class="form-control"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select id="country" class="form-control" required
                                                            ...
                                                            <option value="AF">{{trans('lang.afghanistan')}}</option>

                                                            <option value="AX">{{trans('lang.aland_islands')}}</option>

                                                            <option value="AL">{{trans('lang.albania')}}</option>

                                                            <option value="DZ">{{trans('lang.algeria')}}</option>

                                                            <option value="AS">{{trans('lang.american_samoa')}}</option>

                                                            <option value="AD">{{trans('lang.andorra')}}</option>

                                                            <option value="AO">{{trans('lang.angola')}}</option>

                                                            <option value="AI">{{trans('lang.anguilla')}}</option>

                                                            <option value="AQ">{{trans('lang.antarctica')}}</option>

                                                            <option value="AG">{{trans('lang.antigua_and_barbuda')}}</option>

                                                            <option value="AR">{{trans('lang.argentina')}}</option>

                                                            <option value="AM">{{trans('lang.armenia')}}</option>

                                                            <option value="AW">{{trans('lang.aruba')}}</option>

                                                            <option value="AU">{{trans('lang.australia')}}</option>

                                                            <option value="AT">{{trans('lang.austria')}}</option>

                                                            <option value="AZ">{{trans('lang.azerbaijan')}}</option>
    ...
    function setOutcome(result) {
        ...
        if (result.token) {
            ...
            $.ajax({
                ...
                url: "<?php echo route('process_rental_stripe'); ?>",
