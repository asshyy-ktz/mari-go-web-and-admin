    ...
    async function getOrderDetails() {
        ...
        completedorsersref.get().then(async function (completedorderSnapshots) {
            ...
            if (orderDetails.author.id != user_uuid) {
                ...
                if (orderDetails.hasOwnProperty('estimatedTimeToPrepare') && orderDetails.estimatedTimeToPrepare != null) {
                    // var estimated_pre_time = formatTime(orderDetails.estimatedTimeToPrepare);;
                    // $("#estimated_pre_time").html(estimated_pre_time);
                    ...
                    if(orderDetails.hasOwnProperty('estimatedTimeToPrepare') && orderDetails.estimatedTimeToPrepare!=null){
					    ...
					    $('.estimated_pre_time').append('<label class="col-12 control-label pl-0"><strong>{{trans("lang.estimated_pre_time")}}:</strong><span id=""> ' + time + '</span></label>')
                        $(".estimated_pre_time").show();
