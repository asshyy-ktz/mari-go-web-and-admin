                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="p-3 border-bottom">
                                    ...
                                    <div class="d-flex align-items-center mb-2">
                                        ...
                                        <h6 class="font-weight-bold ml-auto mb-1" style="color:red"; id="special_discount"></h6>
    ...
    async function getOrderDetails() {
        ...
        completedorsersref.get().then(async function (completedorderSnapshots) {
            ...
            if (orderDetails.author.id != user_uuid) {
                ...
                order_items += '<th class="d-head" style="display:none">File</th>';
                ...
                for (let i = 0; i < orderDetails.products.length; i++) {
                    ...
                    checkIsDownloadedItem(orderDetails.products[i]['id']);
                    order_items += '<td class="d-btn" data-pid="'+orderDetails.products[i]['id']+'" style="display:none"></td>';
                ...
                order_discount_val = '(-'+order_discount_val+')';
