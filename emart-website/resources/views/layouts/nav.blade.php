<nav id="main-nav">
    <ul class="second-nav">
        ...
        @auth
            ...
            <?php }else if(@$_COOKIE['service_type'] == "Cab Service"){ ?>
            <li><a href="{{url('my_order')}}" style="display:none"><i class="feather-list mr-2"  style="display:none"></i> {{trans('lang.my_orders')}}</a>
            </li>
            <?php }else{ ?>
            <li><a href="{{url('my_order')}}"><i class="feather-list mr-2"></i> {{trans('lang.my_orders')}}</a></li>
            <?php } ?>
            @if(@$_COOKIE['service_type'] == "Cab Service")
            <li><a href="{{url('transactions')}}" style="display:none"><i class="feather-list mr-2" style="display:none"></i> {{trans('lang.my_transactions')}}
                </a></li>
            @else
