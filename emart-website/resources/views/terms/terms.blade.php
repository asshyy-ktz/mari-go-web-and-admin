     ...
     <div class="d-flex align-items-center justify-content-end pr-5">
      ...
      <div class="dropdown mr-4 m-none">
       <a href="#" class="dropdown-toggle text-dark py-3 d-block" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        <img alt="#" src="img/user/1.jpg" class="img-fluid rounded-circle header-user mr-2 header-user"> {{trans('lang.hi_osahan')}}
       </a>
    ...
    <div class="bg-white rounded shadow-sm sticky_sidebar overflow-hidden">
     ...
     <div class="bg-white profile-details">
      ...
      <a href="{{url('contact_us')}}" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
       <div class="left mr-3">
        <h6 class="font-weight-bold m-0 text-dark"><i class="feather-phone bg-primary text-white p-2 rounded-circle mr-2"></i> {{trans('lang.contact')}}</h6>
       </div>
       <div class="right ml-auto">
        <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
       </div>
      ...
      <a href="{{ route('terms') }}" class="d-flex w-100 align-items-center border-bottom px-3 py-4">
       <div class="left mr-3">
        <h6 class="font-weight-bold m-0 text-dark"><i class="feather-info bg-success text-white p-2 rounded-circle mr-2"></i> {{trans('lang.terms_use')}} </h6>
       </div>
       <div class="right ml-auto">
        <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
       </div>
      ...
      <a href="{{ route('privacy') }}" class="d-flex w-100 align-items-center px-3 py-4">
       <div class="left mr-3">
        <h6 class="font-weight-bold m-0 text-dark"><i class="feather-lock bg-warning text-white p-2 rounded-circle mr-2"></i> {{trans('lang.privacy_policy')}} </h6>
       </div>
       <div class="right ml-auto">
        <h6 class="font-weight-bold m-0"><i class="feather-chevron-right"></i></h6>
       </div>
...
<footer class="section-footer border-top bg-dark">
 <div class="container">
  <section class="footer-top padding-y py-5">
   <div class="row pt-3">
    <aside class="col-md-4 footer-about">
     <article class="d-flex pb-3">
      ...
      <div>
       ...
       <p class="text-muted">{{trans('lang.some_short_text_about_company')}}</p>
    ...
    <aside class="col-sm-3  col-md-2 text-white">
     <h6 class="title">{{trans('lang.for_user')}}</h6>
     <ul class="list-unstyled hov_footer">
 ...
 <section class="footer-copyright border-top py-3 bg-light">
  <div class="container d-flex align-items-center">
   <p class="mb-0">{{trans('lang.all_rights_reserved')}} </p>
  ...
  <li>
   ...
   <ul>
    ...
    <li data-nav-custom-content>
     ...
     {{trans('lang.you_can_add_any_custom_content')}}
     </div>
    </li>
   </ul>
  </li>
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   ...
   <div class="modal-body">
    ...
    <p class="small">{{trans('lang.we_accept')}} <span class="osahan-card ml-2 font-weight-bold">{{trans('lang.master_visa_rupay_card')}}</span></p>
    <form>
     <div class="form-row">
 ...
 <div class="modal-dialog modal-dialog-centered">
  <div class="modal-content">
   ...
   <div class="modal-body py-0">
    ...
    <span class="ml-2 smal text-primary">{{trans('lang.send_an_invite_to')}}</span>
    <p class="mt-3 small">{{trans('lang.invited_friends')}}</p>
    <div class="d-flex align-items-center mb-3">
     <div class="mr-3"><img alt="#" src="img/user1.jpg" class="img-fluid rounded-circle"></div>
     <div>
      <p class="small font-weight-bold text-dark mb-0">{{trans('lang.kate_simpson')}}</p>
    ...
    <div class="d-flex align-items-center mb-3">
     ...
     <div>
      <p class="small font-weight-bold text-dark mb-0">{{trans('lang.andrew_smith')}}</p>
