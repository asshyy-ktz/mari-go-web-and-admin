...
<div class="bg-white p-3 sidebar-item-list">
    ...
    <div class="product-item gold-members row align-items-center py-2 border mb-2 rounded-lg m-0"
        ...
        <input type="hidden" id="category_id_<?php echo @$key1; ?>"
               value="<?php echo $value_item['category_id']; ?>">
        ...
        <div class="media align-items-center col-md-6">
            ...
            <div class="media-body">
                ...
                <input type="hidden" id="size_<?php echo @$key1; ?>"
                       value="<?php echo @$value_item['size']; ?>">
        ...
        <div class="close remove_item col-md-1" data-vendor="<?php echo $key; ?>"
             data-id="<?php echo $key1; ?>"><i
    ...
    <div class="border-bottom py-3">
        ...
        <div class="tip-box">
            ...
            <div class="custom-control custom-radio border-bottom py-2">
                ...
                <label class="custom-control-label" for="10"><span class="currency-symbol-left"></span>10<span
            ...
            <div class="custom-control custom-radio border-bottom py-2">
                ...
                <label class="custom-control-label" for="20"><span class="currency-symbol-left"></span>20<span
                            class="currency-symbol-right"></span></label>
            ...
            <div class="custom-control custom-radio border-bottom py-2">
                ...
                <label class="custom-control-label" for="30"><span class="currency-symbol-left"></span>30<span
                            class="currency-symbol-right"></span></label>
            ...
            <div class="custom-control custom-radio border-bottom py-2" style="display: none;" id="add_tip_box">
                ...
                <input type="number" onchange="tipAmountChange()" name="tip_amount" id="tip_amount"
                       value="<?php echo @$cart['tip_amount']; ?>">
