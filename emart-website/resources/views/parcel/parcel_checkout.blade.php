        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 parcel_payment_right">
                                ...
                                <div class="select_payment-option">
                                    <select id="payment_method" name="payment_method">
                                        ...
                                        <option value="cash on delivery" style="display: none;"
                                                id="cod_box">{{trans('lang.cod')}}
                                        </option>
                                        <option value="razorpay" style="display: none;"
                                                id="razorpay_box">{{trans('lang.razor_pay')}}
                                        </option>
                                        <option value="stripe" style="display: none;"
                                                id="stripe_box">{{trans('lang.stripe')}}
                                        </option>
                                        <option value="paypal" style="display: none;"
                                                id="paypal_box">{{trans('lang.pay_pal')}}
                                        </option>
                                        <option value="payfast" style="display: none;"
                                                id="payfast_box">{{trans('lang.pay_fast')}}
                                        </option>
                                        <option value="paystack" style="display: none;"
                                                id="paystack_box">{{trans('lang.pay_stack')}}
                                        </option>
                                        ...
                                        <option value="wallet" style="display: none;"
                                                id="wallet_box">{{trans('lang.wallet')}}
                                        </option>
                    ...
                    <?php if (@$parcel_cart['parcelDeliveryCharge']) {
                            ...
                            <input type="hidden" id="discountType"
                                   value="<?php echo $discountType ?>">
                            <input type="hidden" id="discountLabel"
                                   value="<?php echo $discount_label; ?>">
         	...
         	<?php
                                    ...
                                    ?>
            <span class="currency-symbol-right"></span>
        </span> <input type="hidden" id="<?php echo $val['title'];?>" value="<?php echo $tax; ?>">
...
<script type="text/javascript">
    ...
    sectionRef.get().then(async function (sectionRefSnapshots) {
        ...
        var section = sectionRefSnapshots.data();
